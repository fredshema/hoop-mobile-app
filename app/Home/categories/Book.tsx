...
export default function Book() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.grd}><Image source={require("../../../assets/auth/location.png")}/></Text>
      <Text style={styles.numbers}>A-6</Text>
      <Text style={styles.text}>Parking Place</Text>
      </View>
      <View style={styles.card2}> 
      <Text style={styles.grd}><Image source={require("../../../assets/auth/clock.png")}/></Text>
      <Text style={styles.numbers}>4 h</Text> 
      <Text style={styles.text}>Time</Text>
      </View>
      </View>
    <View style={styles.rectangle}>
        <Text style={styles.ground}><Image source={require("../../../assets/auth/insurance.png")}/></Text>
